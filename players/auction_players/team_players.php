...
-->
  <?php
      ...
      $sql="SELECT * from Players where Team_Id_Fk='$id'";
	  ...
	  if($result-> num_rows > 0)
		{     
           ...
           <div class="row">
			   ...
			   <?php if($row["Is_Bowler"]=="1" and $row["Is_Batsmen"]=="1")
			  {
				  ?>
	           <div class="cell" data-title="Auction Status">
			       <a><font color="black">All rounder</font></a>
			   </div>
			  <?php
			  }		
			   ...
			   ?>
			   <div class="cell" data-title="Auction Status">
			       <a><font color="orange">Batsman</font></a>
			   </div>
			   <?php
			   }
			   else
			   ...
			   ?>
			   <div class="cell" data-title="Auction Status">
			       <a><font color="Green">Bowler</font></a>
			   </div>
			   <?php
			   }
