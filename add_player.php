		...
		<div class="wrapper wrapper--w680">
				<div class="card card-4">
						<div class="card-body">
								...
								<form action="addplayercheck.php" method="POST">
										<div class="row row-space">
												<div class="col-2">
														<div class="input-group">
																<label class="label">Player name</label>
																<input class="input--style-4" type="text" name="player_name" required>
														</div>
												</div>
												<div class="col-2">
														<div class="input-group">
																<label class="label">Base Price</label>
																<input class="input--style-4" type="number" name="base_price" required>
														</div>
												</div>
										</div>
										<div class="row row-space">
												<div class="col-2">
														<div class="input-group">
																...
																<input class="input--style-4" type="number" name="runs" required>
														</div>
												</div>
												<div class="col-2">
														<div class="input-group">
																<label class="label">Matches</label>
																<input class="input--style-4" type="number" name="matches" required>
														</div>
												</div>
										</div>
										<div class="row row-space">
												<div class="col-2">
														<div class="input-group">
																<label class="label">Innings</label>
																<input class="input--style-4" type="number" name="innings" required>
														</div>
												</div>
												...
												<div class="col-2">
														<div class="input-group">
																<label class="label">Highest score</label>
																<input class="input--style-4" type="number" name="highscore" required>
														</div>
												</div>
										...
										<div class="row row-space">
												...
												<div class="col-2">
														<div class="input-group">
																<label class="label">Centuries</label>
																<input class="input--style-4" type="number" name="centuries" required>
											   ...
											   <div class="col-2">
														    <div class="input-group">
														       <label class="label">Bowling Econ</label>
														 		<input class="input--style-4" type="number" name="bowling_econ" >
													        </div>
												 </div>
									    </div>
										<div class="row row-space">
										<div class="col-2">
														<div class="input-group">
																<label class="label">half centuries</label>
																<input class="input--style-4" type="number" name="half_cen" required>
														</div>
										</div>
										...
										<div class="col-2">
														<div class="input-group">
																...
																<input class="input--style-4" type="text" name="field" required>
														</div>
										</div>
										<div class="col-2">
														<div class="input-group">
																...
																<div class="p-t-10">
																		<label class="radio-container m-r-45">Batsman
																				<input type="radio" checked="checked" name="genre" value="Batsman">
																				<span class="checkmark"></span>
																		</label>
																		<label class="radio-container">Bowler
																				<input type="radio" name="genre" value="Bowler">
																				<span class="checkmark"></span>
																		</label>
																		<label class="radio-container">all rounder
																				<input type="radio" name="genre" value="allrounder">
																				<span class="checkmark"></span>
																		</label>
																</div>
														</div>
