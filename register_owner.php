										...
										<div class="row row-space">
												<div class="col-2">
														<div class="input-group">
																...
																<input class="input--style-4" type="text" name="owner_name" required>
														</div>
												</div>
												<div class="col-2">
														<div class="input-group">
																<label class="label">Team name</label>
																<input class="input--style-4" type="text" name="team_name" required>
														</div>
												</div>
										</div>
										<div class="row row-space">
												...
												<div class="col-2">
														<div class="input-group">
																...
																<input class="input--style-4" type="text" name="profession" required>
														</div>
												</div>
										</div>
										<div class="row row-space">
