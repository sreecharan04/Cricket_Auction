		...
		{     
           ...
           <div class="row">
			   ...
			   <div class="cell" data-title="Auction">
                    <a href="/project/auction/order/order.php?id=<?php echo $row["Player_Id"];?>">view order</a>
			   </div>
			  <?php if($row["Auction_Flag"]=="0")
			  {
				  ?>
	           <div class="cell" data-title="Auction Status">
			       <a><font color="black">Not Auctioned</font></a>
			   </div>
			  <?php
			  }		
			   ...
			   ?>
			   <div class="cell" data-title="Auction Status">
			       <a><font color="orange">Under Auction</font></a>
			   </div>
			   <?php
			   }
			   else if($row["Auction_Flag"]=="2" and $row["Sold_Flag"]=="1")
			   {
			   ?>
			   <div class="cell" data-title="Auction Status">
			       <a><font color="Green">Sold</font></a>
			   </div>
			   <?php
			   }
			   else if($row["Auction_Flag"]=="2" and $row["Sold_Flag"]=="0")
			   {
				?>
				<div class="cell" data-title="Auction Status">
			       <a><font color="Red">Unsold</font></a>
			   </div>
		       <?php 
			   }
		       ?>
